#
# Be sure to run `pod lib lint SwiftCheckboxDialog.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'SwiftCheckboxDialog'
  s.version          = '1.0.1'
  s.summary          = 'Simple checkbox dialog written in Swift.'
  s.swift_version    = '4.2'
...
Simple checkbox dialog written in Swift, it uses AutoLayout to adopt to different screen sizes.
  ...
  # s.resource_bundles = {
  #   'SwiftCheckboxDialog' => ['SwiftCheckboxDialog/Assets/*.png']
  # }
